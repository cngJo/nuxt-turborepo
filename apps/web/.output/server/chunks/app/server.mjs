...
const vueuse_head_plugin_M06Spr4tXC = defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-2acb93bd.mjs').then((m) => m.default || m)
  }
];
...
const router_W6YBFW4kOt = defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b;
  let __temp, __restore;
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-4572f070.mjs').then((r) => r.default || r));
